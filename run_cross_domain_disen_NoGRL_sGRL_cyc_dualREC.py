...
from ops import *
from model_NoGRL_sGRL_cyc_dualREC import create_model
...
parser.add_argument("--cyc_weight", type=float, default=0.1,
...
def append_index(filesets, step=False):
    ...
    if os.path.exists(index_path):
        ...
        index.write(
            "<th>name</th><th>inX</th><th>out(1)</th><th>out(2)</th><th>auto</th><th>swap</th><th>randomimage</th><th>cyc</th><th>inY</th><th>out(1)</th><th>out(2)</th><th>auto</th><th>swap</th><th>rnd</th><th>cyc</th></tr>")
    ...
    for fileset in filesets:
        ...
        all_kinds = ["inputsX", "outputsX2Y", "outputsX2Yp",
                     "auto_outputsX", "im_swapped_X", "sel_auto_X","cycX_output", "inputsY",
                     "outputsY2X", "outputsY2Xp", "auto_outputsY", "im_swapped_Y", "sel_auto_Y", "cycY_output"]
