...
from ops import *
from model_sGRL import create_model
...
parser.add_argument("--classifier_shared_weight", type=float, default=0.1,
...
def append_index(filesets, step=False):
    ...
    if os.path.exists(index_path):
        ...
        index.write(
            "<th>name</th><th>inX</th><th>out(1)</th><th>out(2)</th><th>auto</th><th>swap</th><th>randomimage</th><th>inY</th><th>out(1)</th><th>out(2)</th><th>auto</th><th>swap</th><th>rnd</th></tr>")
